...
namespace TerritoryWars.UI
{
    ...
    {
        [Header("Images")] public Image Player1Avatar;
        public Image Player2Avatar;

        [Header("Player1 Texts")] public TextMeshProUGUI Player1Name;
        public TextMeshProUGUI Player1Score;
        public TextMeshProUGUI Player1CityScores;
        public TextMeshProUGUI Player1CartScores;

        [Header("Player2 Texts")] public TextMeshProUGUI Player2Name;
        public TextMeshProUGUI Player2Score;
        public TextMeshProUGUI Player2CityScores;
        public TextMeshProUGUI Player2CartScores;

        [Header("Winner Text")] public GameObject WinnerGO;
        public TextMeshProUGUI WinnerText;

        [Header("GameObjects")] public List<GameObject> Player1Jokers;
        public List<GameObject> Player2Jokers;
        public GameObject Player1ScoreGO;
        public GameObject Player2ScoreGO;

        [Header("Buttons")] public GameObject Buttons;
        public Button FinishButton;
        public Button ToBoardButton;

        [Header("EvoluteScoreText")] public TextMeshProUGUI CityEvoluteScoreTextPlayer1;
        ...
        [Header("EvoluteScore")] public GameObject CityEvoluteScoreGOPlayer1;
        ...
        [Header("Players Hero")] public Animator Player1Animator;
