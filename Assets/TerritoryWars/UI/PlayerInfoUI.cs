...
namespace TerritoryWars.UI
{
    public class PlayerInfoUI : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("tileScoreTextPlayers")]
        public List<TextMeshProUGUI> roadScoreTextPlayers;
        ...
        {
            SetNames(_sessionManager.SessionContext.PlayersData[0].Username,
        ...
        public void SetCityScores(int firstPlayerCityScore, int secondPlayerCityScore, bool withAnimation = true,
            float delay = 0)
        {
        ...
        public void SetRoadScores(int localPlayerTileScore, int remotePlayerTileScore, bool withAnimation = true,
            float delay = 0)
        {
        ...
        public void SetPlayerScores(int localPlayerScore, int remotePlayerScore, bool withAnimation = true,
            float delay = 0)
        {
        ...
        public void SetPlayerScoresWithoutSwap(int localPlayerScore, int remotePlayerScore, bool withAnimation = true,
            float delay = 0)
        {
